...
//		--------------------- Book 1 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__khuc-trang-ca-ve-nhung-vet-thuong-b1.png?alt=media&token=bf271bde-1c0b-42ef-8581-91eece4a051a")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
				.createdAt(Date.valueOf(LocalDate.now()))
				.lastUpdatedTime(Date.valueOf(LocalDate.now()))
				.lastChangedBy("HUANDM")
...
//		--------------------- Book 2 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__hai-so-phan-b1.png?alt=media&token=24e14824-569d-44fb-bbf1-fa51709e7ce8")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 3 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__cham-dut-thoi-tri-hoan-b1.png?alt=media&token=77107d31-ed7e-4bb2-9d86-bc05f9f44d98")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 4 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__nghe-thuat-quyen-ru-b1.png?alt=media&token=0f2307ca-978c-4fdf-b62a-4fb8eac95d64")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 5 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.publisher(publisherRepository.findByName("Huy Hoàng"))
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__co-the-tu-chua-lanh-b1.png?alt=media&token=5476a3e2-a59b-4c1c-b196-4fb0a420ff17")
...
//		--------------------- Book 6 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2Fkhong-co-dinh-qua-cao-tu-lang-que-buoc-ra-the-gioi-b1.png?alt=media&token=fce6761a-3901-46c7-95b1-e6d4c746af97")
...
//		--------------------- Book 7 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2Fsuc-manh-cua-toan-tam-toan-y-b1.png?alt=media&token=096e61cf-66d1-4dbd-84c4-2db3e05b922e")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 8 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2Fnghe-tho-dan-ke-chuyen-day-con-b1.png?alt=media&token=e4da13de-0dc4-4630-ba5f-3633424b61ef")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 9 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2FAnyConv.com__tu-dauy-nhanh-va-cham-b1.png?alt=media&token=b84fdc16-a73b-43f8-8237-d08ab3c9c574")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
...
//		--------------------- Book 10 -----------------
		...
		bookRepository.save(Book.builder()
				...
				.bookCoverImg("https://firebasestorage.googleapis.com/v0/b/inkmelo-firebase.appspot.com/o/book-covers%2Fmot-cuon-sach-ve-chu-nghia-toi-gian-b1.png?alt=media&token=873de09c-0e48-4915-8280-0a90757225cd")
				.averageStar(0)
				.totalRating(0)
				.bookCoverImg("")
				.genres(genreRepository.findAllByNameInOrderByIdAsc(searchList))
